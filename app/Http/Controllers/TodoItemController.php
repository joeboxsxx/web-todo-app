...
class TodoItemController extends Controller
{
    ...
    {
        $todoItems = TodoItem::where('user-id', Auth::user()->id)->orderBy('created_at', 'desc')->get();
        return $todoItems
    }
    ...
    {
        $item = TodoItem::where('id', $id)->where('userid', Auth::user()->id)->first();
    ...
    {
        TodoItem::where('id', $id)->where('userid', Auth::user()->id)->delete();
        return array('success' => true);
    }
